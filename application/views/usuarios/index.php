    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <label><h4>Usuários</h4></label>
                <a title="Cadastrar novo usuário" href="<?php echo base_url('usuarios/add') ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-user-plus"></i></a>
            </div>
                            ...
                            <?php foreach ($usuarios as $user): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php echo ($user->active == 1 ? '<span class="badge badge-info btn-sm">Ativo</span>' : '<span class="badge badge-primary btn-sm">Inativo</span>'); ?></td>
                                    <td class="text-center">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-success" href="<?php echo base_url('usuarios/del/' . $user->id); ?>">Sim</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
