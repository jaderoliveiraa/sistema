    ...
    <div class="container-fluid">
        ...
        <div class="card shadow ">
            <div class="card-header py-3 pb-0 mb-0 form-control form-control-user-date">
                <p><strong><i class="fas fa-clock" style="color: blue;"></i>&nbsp;Última Edição:  </strong><?php echo formata_data_banco_com_hora($vendedor->vendedor_data_alteracao); ?></p>
            </div>
                    ...
                    <fieldset class="m-2 mt-0 border pl-2 pr-2 pb-1 pt-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-user-date  h-50" name="vendedor_nome_completo" placeholder="Digite o nome do vendedor" value="<?php echo $vendedor->vendedor_nome_completo ?>">
                                <?php echo form_error('vendedor_nome', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            
                            <div class="col-md-3">
                                <label for="formGroupExampleInput">Matrícula</label>
                                <input type="text" class="form-control form-control-user-date  h-50" name="vendedor_codigo" value="<?php echo $vendedor->vendedor_codigo ?>" readonly="">
                                <?php echo form_error('vendedor_codigo', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>

                            <div class = "col-md-3">
                                <label for = "formGroupExampleInput">CPF</label>
                                <input type = "text" class = "form-control form-control-user-date h-50 cpf" name = "vendedor_cpf" placeholder = "Cpf do Vendedor" value = "<?php echo $vendedor->vendedor_cpf ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-user-date rg h-50" name="vendedor_rg" placeholder="" value="<?php echo $vendedor->vendedor_rg ?>">
                    ...
                    <fieldset class="m-2 mt-1 border pl-2 pr-2 pb-1 pt-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="email" class="form-control form-control-user-date h-50" name="vendedor_email" placeholder="Digite o E-mail" value="<?php echo $vendedor->vendedor_email ?>">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user-date phone_with_ddd h-50" name="vendedor_telefone" placeholder="Digite o Telefone Fixo" value="<?php echo $vendedor->vendedor_telefone ?>">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user-date sp_celphones h-50" name="vendedor_celular" placeholder="Digite o Celular" value="<?php echo $vendedor->vendedor_celular ?>">
                    ...
                    <fieldset class="m-2 mt-1 border pl-2 pr-2 pb-1 pt-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control form-control-user-date h-50" name="vendedor_endereco" placeholder="Digite o Endereço" value="<?php echo $vendedor->vendedor_endereco ?>">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control form-control-user-date h-50" name="vendedor_numero_endereco" placeholder="Digite Número" value="<?php echo $vendedor->vendedor_numero_endereco ?>">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control form-control-user-date h-50" name="vendedor_complemento" placeholder=" Ex: Lj, Ap..." value="<?php echo $vendedor->vendedor_complemento ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-user-date h-50" name="vendedor_bairro" placeholder="Digite o bairro" value="<?php echo $vendedor->vendedor_bairro ?>">
                                <?php echo form_error('vendedor_bairro', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>

                            <div class="col-md-4">
                                <label for="formGroupExampleInput">Cidade</label>
                                <input type="text" class="form-control form-control-user-date h-50" name="vendedor_cidade" placeholder="Cidade" value="<?php echo $vendedor->vendedor_cidade ?>">
                                <?php echo form_error('vendedor_cidade', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>

                            <div class="col-md-1">
                                <label for="formGroupExampleInput">Estado</label>
                                <input type="text" class="form-control form-control-user-date uf h-50" name="vendedor_estado" placeholder=" UF" value="<?php echo $vendedor->vendedor_estado ?>">
                                <?php echo form_error('vendedor_estado', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>

                            <div class="col-md-4">
                                <label for="formGroupExampleInput">Cep</label>
                                <input type="text" class="form-control form-control-user-date cep h-50" name="vendedor_cep" placeholder="Cep" value="<?php echo $vendedor->vendedor_cep ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control form-control-user-date h-50" name="vendedor_ativo">
                                    ...
                                    <option class="h-50" value="1" <?php echo($vendedor->vendedor_ativo == 1) ? 'selected' : '' ?> >Ativo</option>
                                    <option class="h-50" value="0" <?php echo($vendedor->vendedor_ativo == 0) ? 'selected' : '' ?> >Inativo</option>
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control form-control-user-date h-50 mb-1" name="vendedor_obs" placeholder="Digite aqui as observações sobre o vendedor"><?php echo $vendedor->vendedor_obs ?></textarea>
