    ...
    <div class="container-fluid">
        ...
        <div class="card shadow ">
            <div class="card-header py-3 pb-0 mb-0 form-control form-control-user-date">
                <p><strong><i class="fas fa-clock" style="color: blue;"></i>&nbsp;Última Edição:  </strong><?php echo formata_data_banco_com_hora($conta_pagar->conta_pagar_data_alteracao); ?></p>
            </div>
                ...
                <form method="POST" name="form_edit">
                    ...
                    <fieldset class="m-2 mt-0 border pl-2 pr-2 pb-1 pt-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-user-date" name="conta_pagar_descricao" placeholder="Descrição da Conta" value="<?php echo $conta_pagar->conta_pagar_descricao ?>">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control form-control-user-date money2" name="conta_pagar_valor" placeholder="Valor da Conta" value="<?php echo $conta_pagar->conta_pagar_valor ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="custom-select" name="conta_pagar_status">
                                    ...
                                    <option value="1" <?php echo ($conta_pagar->conta_pagar_status == 1 ? 'selected' : '') ?>>Pagamento Efetuado</option>
                                    <option value="0" <?php echo ($conta_pagar->conta_pagar_status == 0 ? 'selected' : '') ?>>Pagamento não Efetuado</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control h-50" name="conta_pagar_obs"><?php echo $conta_pagar->conta_pagar_obs ?></textarea>
                    ...
                    <div class="form-group row float-right mt-2 mb-0">
                        <div class="col-md-12 float-right">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm float-right"<?php echo ($conta_pagar->conta_pagar_status == 1 ? 'disabled': '') ?> ><?php echo ($conta_pagar->conta_pagar_status == 1 ? 'Conta Paga': 'Salvar') ?></button>
