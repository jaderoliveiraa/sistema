...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
            ...
            <?php if (isset($contador_notificacoes) && $contador_notificacoes > 0) : ?>
                ...
                <li class="nav-item dropdown no-arrow mx-1">
                    <a class="nav-link dropdown-toggle blink_me" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <!-- Counter - Alerts -->
                        <span class="badge badge-danger badge-counter"><?php echo(isset($contador_notificacoes) ? $contador_notificacoes : '') ?></span>
                    </a>
                    <!-- Dropdown - Alerts -->
                    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                        ...
                        <?php if (isset($contas_receber_vencidas)) : ?>
                            ...
                            <a title="Gerenciar contas a receber" class="dropdown-item d-flex align-items-center" href="<?php echo base_url('receber') ?>">
                                ...
                                <div>
                                    <div class="small text-gray-900"><?php echo formata_data_banco_sem_hora(date('Y-m-d')) ?></div>
                        ...
                        <?php if ($contas_pagar_vencem_hoje > 0) : ?>

                            <a title="Gerenciar contas a pagar que vencem hoje" class="dropdown-item d-flex align-items-center" href="<?php echo base_url('pagar') ?>">
                                <div class="mr-3">
                        ...
                        <?php if ($contas_receber_vencem_hoje > 0) : ?>

                            <a title="Gerenciar contas a receber vencidas" class="dropdown-item d-flex align-items-center" href="<?php echo base_url('receber') ?>">
                                <div class="mr-3">
                                    <div class="icon-circle bg-warning">
                                        <i class="fas fa-hand-holding-usd text-white"></i>
                                    </div>
        ...
        <li class="nav-item dropdown no-arrow animated--fade-in">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <?php
                $user = $this->ion_auth->user()->row();
                ?>
                <span class="mr-2 d-none d-lg-inline text-gray-600"><?php echo 'Olá, ' . $user->first_name ?></span>
                <span class=""><i class="far  fa-2x fa-user" style="color: mediumseagreen;"></i></span>
            </a>
            <!-- Dropdown - User Information -->
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?php echo base_url('usuarios/edit/' . $this->session->userdata('user_id')); ?>">
                    <i class="fas fa-user fa-sm fa-fw mr-2 text-blue-900" style="color: Tomato;"></i>
                    Perfil
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-blue-900" style="color: Dodgerblue;"></i>
                    Sair
                </a>
            </div>
        </li>
