    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url('situacao'); ?>">Situações</a></li>
                ...
                <form method="POST" name="form_add">
                    ...
                    <fieldset class="m-2 mt-0 border pl-2 pr-2 pb-1 pt-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-user-date  h-50" name="situacao_nome" placeholder="Digite a situação">
                    ...
                    <div class="form-group row float-right mt-2 mb-0">
                        <div class="col-md-12 float-right">
                            <a title="Voltar para a lista de Vendedores" href="<?php echo base_url('situacoes'); ?>" class="btn btn-success btn-sm mr-2"><i class="fas fa-arrow-left"></i>&nbsp; Voltar</i></a>
