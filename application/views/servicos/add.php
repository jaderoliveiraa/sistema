                ...
                <form method="POST" name="form_add">
                    ...
                    <fieldset class="m-2 mt-0 border pl-2 pr-2 pb-1 pt-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-user-date  h-50" name="servico_nome" placeholder="Digite o nome do servico">
                                <?php echo form_error('servico_nome', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            
                            <div class="col-md-3">
                                <label for="formGroupExampleInput">Descrição</label>
                                <input type="text" class="form-control form-control-user-date  h-50" name="servico_descricao" placeholder="Descrição do Serviço">
                            ...
                            <div class = "col-md-3">
                                ...
                                <input type = "text" class = "form-control form-control-user-date money2" name = "servico_preco" placeholder = "Valor R$">
                    ...
                    <div class="form-group row float-right mt-2 mb-0">
                        <div class="col-md-12 float-right">
                            <a title="Voltar para a lista de Vendedores" href="<?php echo base_url('servicos'); ?>" class="btn btn-success btn-sm mr-2"><i class="fas fa-arrow-left"></i>&nbsp; Voltar</i></a>
