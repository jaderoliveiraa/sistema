    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <label><h4>Categorias</h4></label>
                <a title="Cadastrar nova Categoria" href="<?php echo base_url('categorias/add') ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-vector-square"></i>&nbsp;&nbsp;Novo</i></i></a>
            </div>
                            ...
                            <?php foreach ($categorias as $categoria): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php echo ($categoria->categoria_ativa == 1 ? '<span class="badge badge-info btn-sm">Ativa</span>' : '<span class="badge badge-primary btn-sm">Inativa</span>'); ?></td>
                                    <td class="text-center">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-success" href="<?php echo base_url('categorias/del/' . $categoria->categoria_id); ?>">Sim</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
