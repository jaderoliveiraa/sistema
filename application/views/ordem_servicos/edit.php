    ...
    <div class="container-fluid">
        ...
        <div class="card shadow ">
            <div class="card-header py-3 pb-0 mb-0 form-control form-control-user-date">
                <p><strong><i class="fas fa-clock" style="color: blue;"></i>&nbsp;Última Edição:  </strong><?php echo formata_data_banco_com_hora($ordem_servico->ordem_servico_data_alteracao); ?></p>
            </div>
                        ...
                        <div class="table-responsive">
                            <table id="table_servicos" class="table">
                                ...
                                <tbody id="lista_servicos" class="">
                                    ...
                                    <?php if (isset($ordem_tem_servicos)): ?>

                                        <?php $i = 0; ?>

                                        <?php foreach ($ordem_tem_servicos as $os_servico): ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="custom-select" name="ordem_servico_marca_equipamento_id" >
                                        ...
                                        <?php foreach ($marcas as $marca): ?>
                                            <option value="<?php echo $marca->marca_id; ?>" <?php echo ($marca->marca_id == $ordem_servico->ordem_servico_marca_equipamento_id ? 'selected' : '') ?> ><?php echo $marca->marca_nome; ?></option>
                                        <?php endforeach; ?>
                                    </select>
