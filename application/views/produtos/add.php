                    ...
                    <fieldset class="m-2 mt-0 border pl-2 pr-2 pb-1 pt-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control form-control-user-date" name="produto_codigo" readonly="" value="<?php echo $produto_codigo; ?>">
                            </div>

                            <div class="col-md-10">
                                <label>Descrição do Produto</label>
                                <input type="text" class="form-control form-control-user-date  h-50" name="produto_descricao" placeholder="Descrição do Produto" value="<?php echo set_value('produto_descricao'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="produto_unidade" class="form-control form-control-user-date" value="<?php echo set_value('produto_unidade'); ?>">
                    ...
                    <fieldset class="m-2 mt-0 border pl-2 pr-2 pb-1 pt-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-user-date money h-50" name="produto_preco_custo" placeholder="Preço de Custo" value="<?php echo set_value('produto_preco_custo'); ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control form-control-user-date money h-50" name="produto_preco_venda" placeholder="Preço de Venda" value="<?php echo set_value('produto_preco_venda'); ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control form-control-user-date h-50" name="produto_estoque_minimo" placeholder="Estoque Mínimo" value="<?php echo set_value('produto_estoque_minimo'); ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control form-control-user-date h-50" name="produto_qtde_estoque" placeholder="Quantidade em Estoque" value="<?php echo set_value('produto_qtde_estoque'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <textarea class="form-control h-50" name="produto_obs"><?php echo set_value('produto_obs');?></textarea>
