    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url('vendas'); ?>">Ordens de Serviços</a></li>
        ...
        <div class="card shadow ">
            <div class="card-header py-3 pb-0 mb-0 form-control form-control-user-date">
                <p><strong><i class="fas fa-clock" style="color: blue;"></i>&nbsp;Última Edição:  </strong><?php echo formata_data_banco_com_hora($venda->venda_data_alteracao); ?></p>
            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 mb-1 mb-sm-0">
                                    ...
                                    <select class="custom-select" name="venda_tipo" required="">
                                        ...
                                        <option value="2" <?php echo ($venda->venda_tipo == 3 ? 'selected' : 'disabled') ?>>Devolução</option>
                                    </select>
