    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url('relatorios/pagar'); ?>">Relatórios</a></li>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row pt-3 pl-3">
                            <div class="custom-control custom-radio col offset-md-1 mb-2">
                                <input type="radio" id="customRadio1" name="contas" value="pagar" class="custom-control-input" checked="">
