    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url('relatorios/os'); ?>">Relatórios</a></li>
            ...
            <div class="card-body pt-0 mt-0">
                <form action="" class="user" name="form_os" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <legend class="font-small"><i class="fas fa-calendar-alt"></i></i>&nbsp;&nbsp;Escolha o período</legend>
                    ...
                    <div class="mt-3 float-right">
                        <button class="btn btn-primary btn-sm mr-2" target="_blank">Gerar relatório</button>
                    </div>
