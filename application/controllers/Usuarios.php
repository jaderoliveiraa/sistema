...
//                }
    ...
    //função para validar se já existe email
    public function email_check($email) {
        ...
        if ($this->core_model->get_by_id('users', array('email' => $email, 'id' != $usuario_id))) {
            ...
            $this->form_validation->set_message('email_check', 'Esse E-mail já foi cadastrado!');
    ...
    //função para validar se já existe usuario
    public function username_check($username) {
        ...
        if ($this->core_model->get_by_id('users', array('username' => $username, 'id' != $usuario_id))) {
            ...
            $this->form_validation->set_message('username_check', 'Esse Usuário já está em uso, escolha outro usuário!');
    ...
    public function del($usuario_id = NULL) {
        ...
        if ($this->ion_auth->is_admin($usuario_id)) {
            ...
            $this->session->set_flashdata('error', 'Não é permitido excluir usuarios administradores!');
            redirect('usuarios');
        }
