...
class Pagar extends CI_Controller {
    ...
    public function index() {
        ...
        $data = array(
            ...
            'contas_pagar' => $this->financeiro_model->get_all_pagar(''), // Pegar todas as contas a pagar        
        );
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('conta_pagar_descricao', '', 'required|min_length[4]|max_length[150]');
        ...
        if (!$conta_pagar_id || !$this->core_model->get_by_Id('contas_pagar', array('conta_pagar_id' => $conta_pagar_id))) {
            ...
            if ($this->form_validation->run()) {
                ...
                $data = array(
                    ...
                    'conta_pagar' => $this->core_model->get_by_id('contas_pagar', array('conta_pagar_id' => $conta_pagar_id)), // Pegar todas as contas a pagar        
                    'fornecedores' => $this->core_model->get_all('fornecedores'), // Pegar todos os fornecedores     
                );
